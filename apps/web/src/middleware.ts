...
export const config = {
  matcher: [
    ...
    '/((?!_next/static|_next/image|favicon.ico|api/webhooks|api/inngest|api/auth/google|api/unsubscribe|api/events/.*/ics|api/events/.*/qr|unsubscribe|rsvp|claim|arrival|.*\\..*).*)',
  ],
};
