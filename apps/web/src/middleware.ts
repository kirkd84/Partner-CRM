...
export const config = {
  matcher: [
    ...
    '/((?!_next/static|_next/image|favicon.ico|api/webhooks|api/inngest|api/auth/google|api/unsubscribe|api/events/.*/ics|api/events/.*/qr|api/health|api/cron|unsubscribe|rsvp|claim|arrival|share|legal|.*\\..*).*)',
  ],
};
