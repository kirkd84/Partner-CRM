...
const ITEMS = [
  ...
  { href: '/admin/ai-follow-ups', label: 'AI Follow-Ups', icon: Workflow, adminOnly: false },
  { href: '/admin/ai-follow-up-queue', label: 'Follow-Up queue', icon: Sparkles, adminOnly: false },
