...
import { ArrowRight, Lasso, Loader2, Sparkles, Trash2 } from 'lucide-react';
        ...
        <Card title="Find new leads in this lasso">
          {!hasLasso ? (
            <p className="text-xs text-gray-500">
              Use the <strong>Lasso a territory</strong> button on the map to draw a polygon, then
              pick which partner types to search.
            </p>
          ) : (
            <>
